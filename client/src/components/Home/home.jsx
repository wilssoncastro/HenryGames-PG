        ...
        <div className='background'>
            ...
            <div className="ContainerCarousel">
                ...
                <Carousel focusOnSelect={false}>
                    ...
                    <item>
                    <Link to='/store/4527'><img className='imagenes' src="https://img.unocero.com/2020/03/call-of-duty-modern-warfare-2-remaster-2-1.jpg" alt= 'img not found'/></Link>
                        <p className="legend">Call of Duty: Modern Warfare 2</p>
                    </item>
                    <item>
                    <Link to='/store/865'><img className='imagenes' src="https://cdn.akamai.steamstatic.com/steam/apps/42700/capsule_616x353.jpg?t=1654809667" alt= 'img not found'/></Link>
                        <p className="legend">Call of Duty: Black Ops</p>
                    </item>
                </Carousel>
                <Carousel focusOnSelect={false}>
                    <item>
                        <Link to='/store/32'><img className='imagenes' src= 'https://cdn.akamai.steamstatic.com/steam/apps/1085660/header_spanish.jpg?t=1653420922' alt= 'img not found'/></Link>
                        <p className="legend">Destiny 2</p>
                    </item>
                    <item>
                    <Link to='/store/326292'><img className='imagenes' src="https://cdn1.epicgames.com/offer/50118b7f954e450f8823df1614b24e80/es-ES_FallGuysSS1_OfferImage_2560x1440_2560x1440-291db57cf0ebc2a5e83e52e4fb0f9740" alt= 'img not found'/></Link>
