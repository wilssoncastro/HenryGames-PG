...
export function unreport_comment(id_comment){
  return function(dispatch){
    return axios.put(`/comments/unreport_comment/${id_comment}`)
    .then(data => {
      dispatch({
...
export function bannedUser(id){
  return async function(dispatch){
    var json = await axios.put(`/users/ban/${id}`);
    return dispatch({
          type: "BAN_USER",
          payload: json.data
      });
...
export function unbannedUser(id){
  return async function(dispatch){
    var json = await axios.put(`/users/unbanned/${id}`);
    return dispatch({
          type: "BANNED_USER",
          id: id,
          payload: json.data
...
export function convertToAdmin(id){
  return async function(dispatch){
    var json = await axios.put(`/users/admin/${id}`);
    return dispatch({
          type: "CONVERT_ADM",
          payload: json.data
      });
...
export function convertToUser(id){
  return async function(dispatch){
    var json = await axios.put(`/users/user/${id}`);
    return dispatch({
          type: "CONVERT_USER",
          payload: json.data
      });
